...
export const Footer = () => {
  ...
  return (
    ...
    <div className="modal__box">
        ...
        <div className="m-1 ml-16 text-sm text-white">Generate Haikuボタンを押すと、俳句を生成します。</div>
        <div className="m-1 ml-16 text-sm text-white">Pic 2 Haikuボタンを押すと、画像をアップロードして、俳句を生成します。</div>
